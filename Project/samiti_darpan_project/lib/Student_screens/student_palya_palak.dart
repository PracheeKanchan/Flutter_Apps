...
import 'package:sumiti_darpan_project/Common_Files/show_dial_box.dart';

class PalyaPalak extends StatefulWidget{

  const PalyaPalak({super.key});
  @override
  State createState()=> _PalyaPalakState();
}

class _PalyaPalakState extends State{

//Dialogue Box Function
void _showPalyaInfoDialog(BuildContext context) {
    showDialog(
      context: context,
                    ...
                    children: <Widget>[
                              ...
                              Row(
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      ShowDialBox.launchDialBox('7030559268');
                                    },
                                    child: Text(
                                      '7030559268 ',
                                      style: GoogleFonts.inter(
